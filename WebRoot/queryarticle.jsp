    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="Doqueryarticle">查看文章</a></li>
  ...
  <div class="container">
    ...
    <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
               <c:forEach items="${requestScope.listtp}" var="g">
                <tr>
                  <td><c:out value="${g.artId}"></c:out></td>
                  <td><c:out value="${g.userName}"></c:out></td>
                  <td><c:out value="${g.artTitle}"></c:out></td>
                  <td><c:out value="${g.artTime}"></c:out></td>
               	 <td><a href="Doqueryarticlebyid?id=${g.artId}">去看全文</a></td>
               	</tr>
               </c:forEach>
              </tbody>
            </table>
...
<div id="footer">
  <div class="container">
    <p class="text-muted credit">查看文章</p>
  </div>
</div>
