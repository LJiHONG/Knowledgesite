...
<html lang="en">
	<head>
		...
		<style type="text/css"> 
			 body{background: url(img/5.jpg) no-repeat;background-size:cover;}  
		</style>
	</head>
	<body>
      ...
      <h1><c:out value="《${requestScope.title}》"></c:out></h1>
	    ...
	    <form class="form-horizontal" action="Doputtopic" method="post">
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <p class="form-control-static"><c:out value="${requestScope.name}"></c:out></p>
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputPassword3" class="col-sm-2 control-label">文章内容：</label>
		    <div class="col-sm-10">
		      <p class="form-control-static"><c:out value="${requestScope.content}"></c:out></p>
		    </div>
		  </div>
	</form>
  </div>
