    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="#">关注用户</a></li>
        </ul>
      </div><!--/.nav-collapse -->
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
               <c:forEach items="${requestScope.ltur}" var="g">
                <tr>
                  <td><c:out value="${g.userId}"></c:out></td>
                  <td><c:out value="${g.userName}"></c:out></td>
                  <td><c:out value="${g.integral}"></c:out></td>	
               	</tr>
               </c:forEach>
              </tbody>
            </table>
    	...
    	<div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
               <c:forEach items="${requestScope.ltu}" var="g">
                <tr>
                  <td><c:out value="${g.userId}"></c:out></td>
                  <td><c:out value="${g.userName}"></c:out></td>
                  <td><c:out value="${g.integral}"></c:out></td>
               	 <td><a href="Dofuserbyid?id=${g.userId}">关注他</a></td>	
               	</tr>
               </c:forEach>
              </tbody>
            </table>
...
<div id="footer">
  <div class="container">
    <p class="text-muted credit">我关注的用户</p>
  </div>
</div>
