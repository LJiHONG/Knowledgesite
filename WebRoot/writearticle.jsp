    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="writearticle.jsp">写文章</a></li>
  ...
  <div class="container">
    <div class="page-header">
      <h1>写文章</h1>
	    ...
	    <form class="form-horizontal" action="Dowritearticle" method="post">
		  ...
		  <div class="form-group">
		    <label for="inputEmail3" class="col-sm-2 control-label">文章题目：</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="title" placeholder="文章题目">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputPassword3" class="col-sm-2 control-label">文章内容：</label>
		    <div class="col-sm-10">
		      <textarea name="content" id="groupinfo" rows="10" cols="30" class="form-control" placeholder="文章内容"></textarea>
		    </div>
		  </div>
		  <div class="form-group">
