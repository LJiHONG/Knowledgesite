...
<div id="wrap">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="putquestion.jsp">发起提问</a></li>
  ...
  <div class="container">
    ...
    <form class="form-horizontal" action="Doputquestion" method="post">
		  ...
		  <div class="form-group">
					<label for="" class="col-sm-2 control-label">悬赏积分：</label>
					<div class="col-sm-10">
						<select name="integral" id="" class="form-control">
		  ...
		  <div class="form-group">
		    <label for="inputPassword3" class="col-sm-2 control-label">提问内容：</label>
		    <div class="col-sm-10">
		      <textarea name="content" id="groupinfo" rows="10" cols="30" class="form-control" placeholder="提问内容"></textarea>
		    </div>
		  </div>
		  <div class="form-group">
...
<div id="footer">
  <div class="container">
    <p class="text-muted credit">发起提问</p>
  </div>
</div>
