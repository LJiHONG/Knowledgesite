    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="Doqueryfocusquestion">我关注的提问</a></li>
  ...
  <div class="container">
    ...
    <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
               <c:forEach items="${requestScope.ltak}" var="g">
                <tr>
                  <td><c:out value="${g.aqnId}"></c:out></td>
                  <td><c:out value="${g.userName}"></c:out></td>
                  <td><c:out value="${g.aqnContent}"></c:out></td>
                  <td><c:out value="${g.aqnTime}"></c:out></td>
                  <td><c:out value="${g.aqnIgl}"></c:out></td>
               	 <td><a href="Doqueryquestionbyid?id=${g.aqnId}">去回答</a></td>	
               	</tr>
               </c:forEach>
              </tbody>
            </table>
...
<div id="footer">
  <div class="container">
    <p class="text-muted credit">我关注的提问</p>
  </div>
</div>
